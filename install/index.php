...
// +------------------------------------------------------------------------+
// |
// | @author_url 1: http://www.lecrosoft.com
// | 
// | @author_email: lecrosoft@gmail.com
// +------------------------------------------------------------------------+
// | 
// | Copyright (c) 2018 Quickdating app. All rights reserved.
// +------------------------------------------------------------------------+
// MySQL Hostname
...
<head>
    ...
    <title>Hookbae | Installation</title>
                    ...
                    <div>
                        ...
                        <div class="setting-panel">
                            ...
                            <?php } else if ($page == 'finish') { ?>
                                <div class="req">
                                    <p>Congratulations! The script has been successfully installed and your website is ready.</p>
                                    <p>Login to your admin panel to make changes and modify any default content according to your needs.</p>
                                    <br>
                                    <p>If you have any question, please <a href="mailto:lecrosoft@gmail.com" class="main">let us know</a>.</p>
                                    <br><br>
                                ...
                                <div class="req">
                                    ...
                                    <form action="?page=installation" method="post" class="form-horizontal install-site-setting">
                                        <div class="form-group">
                                            <div class="col-md-1"></div>
                                            <label class="col-md-3" for="siteName">Installation code </label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" name="purshase_code" value="<?php echo (isset($_POST['purshase_code'])) ? trim($_POST['purshase_code']) : ''; ?>">
                                                <span class="help-block">Your Installation code, you can get it from <a href="lecrosoft.com">The Developer</a>.</span>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-1"></div>
